...
#define DARK_BROWN 0x59C2
#define LIGHT_BROWN 0x7262
#define UP_EYE 0x7B0A
#define DOWN_EYE 0x8BED
#define GREY 0x7BCF
#define BLACK 0x0000
#define DARK_RED 0x60E2
#define LIGHT_RED 0x7103
#define EVIL_UP_EYE 0x78C3
#define EVIL_DOWN_EYE 0xE0E3
#define DARK_BLUE 0x31B0
#define LIGHT_BLUE 0x4A96
...
void printWizard(uint8_t whichWizard) {
    ...
    // ------------------------ DARK ROBE
        ...
        {46, 111}, {47, 111}, {50, 111}, {51, 111}, {46, 112}, {47, 112}, {48, 112}, {49, 112}, {46, 113}, {47, 113}, {47, 118}, 
        {47, 119}, {48, 119}, {49, 119}, {50, 119}, {46, 120}, {47, 120}, {48, 120}, {50, 120}, {46, 121}, {47, 121}, {48, 121}, 
        {54, 121}, {55, 121}, {46, 122}, {47, 122}, {46, 123}, {47, 123}, {45, 124}, {46, 124}, {47, 124}, {48, 124}, {53, 124}, {54, 124}, 
        {47, 125}, {48, 125}, {52, 125}, {53, 125}};
    ...
    // // ------------------------ BEARD
        ...
        uint8_t beard[20][2] = { {48, 115}, 
        {48, 116}, {48, 117}, {49, 117}, {51, 117}, 
        {52, 117}, {48, 118}, {49, 118}, {50, 118}, 
        {51, 118}, {52, 118}, {53, 118}, {51, 119}, 
        {52, 119}, {53, 119}, {52, 120}, {53, 120}, 
        {52, 121}, {53, 121}, {53, 122} };
    ...
    // ------------------------ STAFF LIGHT
        ...
        uint8_t staffLight[12][2] = {{58, 109},
                                    {58, 111},
                                    {57, 112},
                                    {57, 113},
                                    {57, 114},
